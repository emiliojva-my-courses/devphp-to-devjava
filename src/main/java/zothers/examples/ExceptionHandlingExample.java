...
class ServicoBancario {
    ...
    public void transferir(ContaBancaria origem, ContaBancaria destino, double valor) 
        ...
        // Pode lançar legacy.fundamentals.SaldoInsuficienteException (unchecked)
        origem.sacar(valor);
        
        // Pode lançar legacy.fundamentals.UsuarioInvalidoException (checked)
...
public class ExceptionHandlingExample {
    ...
    private static void demonstrarCheckedExceptions(ServicoBancario servico) {
        ...
        System.out.println("Java: try { ... } catch (legacy.fundamentals.UsuarioInvalidoException e) { ... }\n");
